        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    @endif
                    <div class="row">
                        <form class="form-horizontal" method="POST" enctype="multipart/form-data" action="{{ url('/editPost', array($posts->id)) }}">
                            {{ csrf_field() }}
                            ...
                            <div class="form-group{{ $errors->has('post_title') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="post_title" type="input" class="form-control" name="post_title" value="{{ $posts->post_title }}" required autofocus>
                            ...
                            <div class="form-group{{ $errors->has('post_body') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <textarea id="post_body" rows="5" class="form-control" name="post_body" required autofocus>
                                        {{$posts->post_body}}
                                    </textarea>    
